...
pub struct MintyPlexContract<'a, T, C, E, Q>
where
...
// impl<'a, T, C, E, Q> Cw721<T, C> for MintyPlexContract<'a, T, C, E, Q>
// where
//     T: Serialize + DeserializeOwned + Clone,
//     C: CustomMsg,
//     E: CustomMsg,
...
impl<T, C, E, Q> Default for MintyPlexContract<'static, T, C, E, Q>
where
    T: Serialize + DeserializeOwned + Clone,
    E: CustomMsg,
    Q: CustomMsg,
